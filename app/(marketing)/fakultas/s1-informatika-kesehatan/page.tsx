...
export default function InformatikaKesehatanPage() {
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 w-full justify-center">
            <div className="flex flex-col items-center">
              <div className="relative flex items-center justify-center mb-4">
                ...
                <div className="bg-gradient-to-br from-primary-600 to-blue-400 text-white rounded-full shadow-xl border-4 border-primary-300 px-10 py-8 text-3xl font-extrabold tracking-wide flex flex-col items-center animate-fade-in">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {curriculumData.map((item, idx) => (
              <div
                key={idx}
                className="relative bg-gradient-to-br from-primary-50 to-blue-100 rounded-2xl shadow-md border border-primary-100 p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow group"
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-xl bg-gradient-to-br from-primary-600 to-blue-600 text-white flex items-center justify-center text-2xl shadow-lg border-4 border-white group-hover:scale-110 transition-transform">
                  💻
                </div>
                <div className="mt-8">
      ...
      {/* CTA Final Section */}
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gradient-to-r from-primary-600 via-blue-400 to-primary-400 text-white">
