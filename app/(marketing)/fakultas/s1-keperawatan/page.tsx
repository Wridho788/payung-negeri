...
const accreditation = {
  ...
  agency: "LAM-PTKes",
  sk: "Nomor SK: 9104/SK/LAM-PTKes/AKRED/S1/IV/2026",
  year: "2026",
};

const vision = "Menjadi program studi unggulan yang membangun dasar keilmuan dan kompetensi keperawatan menuju perawat profesional dan berdaya saing nasional.";

const missions = [
  "Menyelenggarakan pendidikan keperawatan berbasis teori dan praktik.",
  "Mengembangkan penelitian dan inovasi di bidang keperawatan.",
  "Meningkatkan pengabdian kepada masyarakat melalui pelayanan kesehatan.",
];

const goals = [
  "Menghasilkan sarjana keperawatan profesional dan berkarakter.",
  "Meningkatkan kemampuan penelitian dan analisis kesehatan.",
  "Mendorong pengabdian dan pelayanan kesehatan berkualitas.",
];

const advantagesData = [
  {
    icon: "📚",
    title: "Kurikulum Berbasis Praktik & Teori",
    description: "Keseimbangan antara pembelajaran teori, praktik laboratorium, dan klinik lapangan.",
  },
  {
    icon: "🏥",
    title: "Pengalaman Klinik di Fasilitas Kesehatan",
    description: "Praktikum di rumah sakit, puskesmas, dan komunitas kesehatan.",
  },
  {
    icon: "🔬",
    title: "Pembelajaran Berbasis Penelitian",
    description: "Fokus pada pengembangan penelitian dan evidence-based practice.",
  },
  {
    icon: "🤝",
    title: "Pengembangan Soft Skill & Leadership",
    description: "Pelatihan komunikasi, kepemimpinan, dan kolaborasi tim medis.",
  },
];
...
const careerData = [
  { title: "Perawat (lanjutan profesi)", desc: "Dasar untuk melanjutkan ke Profesi Ners dan praktik profesional." },
  { title: "Manajer Keperawatan", desc: "Mengelola pelayanan keperawatan di fasilitas kesehatan." },
  { title: "Peneliti Kesehatan", desc: "Melakukan penelitian di bidang keperawatan dan kesehatan masyarakat." },
  { title: "Tenaga Kesehatan Pemerintah", desc: "Bekerja di puskesmas, dinas kesehatan, dan program pemerintah." },
  { title: "Konsultan Keperawatan", desc: "Memberikan konsultasi dan edukasi keperawatan." },
];

const curriculumData = [
  { sem: "1-2", mk: "Dasar Keperawatan, Anatomi, Fisiologi, Praktikum", sks: "14" },
  { sem: "3-4", mk: "Keperawatan Medikal Bedah, Kesehatan Jiwa, Klinik", sks: "15" },
  { sem: "5-6", mk: "Keperawatan Komunitas, Penelitian, Praktikum", sks: "13" },
  { sem: "7-8", mk: "Keperawatan Spesialistik, Skripsi, Klinik", sks: "12" },
];
...
const lecturersData = [
  ...
  },
  {
    ...
    title: "Dosen Keperawatan Medikal Bedah",
    img: "/rektor.png",
  },
  {
    name: "Rina Sari, S.Kep, Ns, M.Kep",
    title: "Dosen Penelitian Keperawatan",
    img: "/rektor.png",
  },
];
...
export default function S1KeperawatanPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 px-6 md:px-8 bg-gradient-to-br from-primary-50 via-blue-100 to-white text-primary-900 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-primary-900/80 max-w-2xl mx-auto mb-8 leading-relaxed font-semibold">
              Membangun Dasar Keilmuan dan Kompetensi Menuju Perawat Profesional
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg mb-4 leading-relaxed">
              Program Studi S1 Ilmu Keperawatan dirancang untuk membekali mahasiswa dengan dasar keilmuan keperawatan, keterampilan klinis, serta kemampuan analisis dan penelitian di bidang kesehatan.
            </p>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3"><span className="text-blue-600 font-bold">✔</span> Kurikulum teori dan praktik klinik</li>
              <li className="flex items-start gap-3"><span className="text-blue-600 font-bold">✔</span> Pengembangan soft skill dan penelitian</li>
              <li className="flex items-start gap-3"><span className="text-blue-600 font-bold">✔</span> Persiapan lanjut ke Profesi Ners</li>
            </ul>
          </div>
          <div className="relative h-80 md:h-96 rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/lab-praktikum.jpg"
              alt="Praktikum S1 Keperawatan"
              fill
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 w-full justify-center">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-blue-100 px-8 py-6 flex flex-col items-center justify-center max-w-xs">
              ...
              <div className="text-lg font-bold text-blue-700 mb-1">Terdaftar Resmi LAM-PTKes</div>
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Kurikulum kami menekankan dasar keperawatan, praktik klinik, penelitian, dan pengembangan soft skill untuk membekali lulusan siap lanjut ke Profesi Ners.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {curriculumData.map((item, idx) => (
              ...
              >
                ...
                <div className="mt-8">
                  <div className="text-blue-700 font-bold text-lg mb-2">Semester {item.sem}</div>
                  <div className="text-gray-900 font-semibold mb-2">{item.mk}</div>
                  <div className="inline-block px-4 py-1 bg-blue-100 text-blue-700 rounded-full font-bold text-sm mt-2">
                    {item.sks} SKS
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-white">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-900 mb-6">Jalur Lanjutan: Profesi Ners</h2>
          <p className="text-gray-700 text-lg mb-6">
            Setelah menyelesaikan S1 Ilmu Keperawatan, mahasiswa dapat melanjutkan ke Program Profesi Ners untuk menjadi perawat profesional yang berlisensi dan siap praktik klinik.
          </p>
          <a
            href="/fakultas/profesi-ners"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {lecturersData.map((lect, idx) => (
              ...
              >
                ...
                <p className="text-blue-700 font-semibold">{lect.title}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center overflow-hidden">
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg animate-fade-in-up">
              Mulai Perjalanan Anda Menjadi Perawat Profesional
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-10 animate-fade-in-up delay-100">
              Daftar sekarang dan wujudkan impian Anda menjadi perawat profesional yang berkarakter dan siap lanjut ke Profesi Ners.
            </p>
            <a
              href="/kontak"
