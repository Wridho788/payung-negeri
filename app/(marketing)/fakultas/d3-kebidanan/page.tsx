...
const accreditation = {
  status: "Baik Sekali",
  agency: "BAN-PT",
  sk: "Nomor SK: 9102/SK/BAN-PT/AKRED/D3/IV/2026",
  year: "2026",
};

const vision = "Menjadi program vokasi kebidanan unggulan yang menghasilkan bidan terampil, siap kerja, dan berdaya saing nasional.";

const missions = [
  "Menyelenggarakan pendidikan kebidanan praktis dan berkualitas.",
  "Menghasilkan bidan profesional siap kerja.",
  "Meningkatkan mutu pelayanan kebidanan masyarakat.",
];

const goals = [
  "Menghasilkan bidan terampil dan siap kerja.",
  "Meningkatkan pelayanan kesehatan ibu & anak.",
  "Mendorong kesiapan kerja lulusan di dunia nyata.",
];
...
const advantagesData = [
  ...
  },
  {
    ...
    description: "Lulus lebih cepat, langsung siap kerja di bidang kebidanan.",
  },
  {
    icon: "💼",
  ...
  {
    icon: "🎓",
    title: "Pendekatan Vokasi",
    description: "Pembelajaran berbasis skill dan praktik, bukan hanya teori.",
  },
];
...
const competenciesData = [
  ...
  "Pelayanan klinis dan praktik lapangan",
  "Komunikasi pasien dan keluarga",
];

const careerData = [
  { title: "Bidan Klinik", desc: "Langsung praktik di klinik bersalin dan fasilitas kesehatan swasta." },
  { title: "Puskesmas", desc: "Bidan di puskesmas dan layanan kesehatan masyarakat." },
  { title: "Rumah Sakit", desc: "Bidan di rumah sakit pemerintah maupun swasta." },
  { title: "Praktik Mandiri", desc: "Membuka praktik mandiri (dengan syarat sesuai regulasi)." },
  { title: "Tenaga Kesehatan Lapangan", desc: "Bidan di lapangan, program kesehatan ibu & anak, dan edukasi masyarakat." },
];

const curriculumData = [
  { sem: "1", mk: "Anatomi, Fisiologi, Dasar Kebidanan, Praktikum", sks: "12" },
  { sem: "2", mk: "Kehamilan Normal, Klinik Lapangan, Simulasi Kasus", sks: "12" },
  { sem: "3", mk: "Persalinan, Magang, Praktik Klinik", sks: "14" },
  { sem: "4", mk: "Nifas, Bayi Baru Lahir, Tugas Akhir", sks: "12" },
];

const lecturersData = [
  {
    name: "Dra. Siti Aminah, M.Keb",
    title: "Ketua Program Studi",
    img: "/rektor.png",
  },
  {
    name: "Yuni Astuti, S.ST, M.Kes",
    title: "Dosen Praktik Klinik",
    img: "/rektor.png",
  },
  {
    name: "Rina Dewi, S.ST, M.Keb",
...
export default function D3KebidananPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 px-6 md:px-8 bg-gradient-to-br from-[#FCAF35]/30 via-orange-100 to-white text-primary-900 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-primary-900/80 max-w-2xl mx-auto mb-8 leading-relaxed font-semibold">
              Program Vokasi untuk Menjadi Bidan Terampil dan Siap Kerja
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg mb-4 leading-relaxed">
              Program D3 Kebidanan berfokus pada pembelajaran praktis dan pengalaman klinis untuk menghasilkan tenaga bidan yang siap terjun langsung ke dunia kerja.
            </p>
          ...
          <div className="relative h-80 md:h-96 rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/gedung.jpg"
              alt="Praktik Klinik D3 Kebidanan"
              fill
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 w-full justify-center">
            <div className="flex flex-col items-center">
              <div className="relative flex items-center justify-center mb-4">
                ...
                <div className="bg-gradient-to-br from-[#FCAF35] to-orange-400 text-primary-900 rounded-full shadow-xl border-4 border-yellow-300 px-10 py-8 text-3xl font-extrabold tracking-wide flex flex-col items-center animate-fade-in">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-yellow-100 px-8 py-6 flex flex-col items-center justify-center max-w-xs">
              ...
              <div className="text-lg font-bold text-yellow-700 mb-1">Terdaftar Resmi BAN-PT</div>
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Kurikulum kami menekankan praktikum, klinik lapangan, magang, dan simulasi kasus untuk membekali lulusan siap kerja di dunia kebidanan.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div className="relative max-w-4xl mx-auto text-center overflow-hidden">
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow-lg animate-fade-in-up">
              Mulai Karier Anda sebagai Bidan Profesional
            </h2>
            <p className="text-lg md:text-xl text-primary-900/90 mb-10 animate-fade-in-up delay-100">
              Daftar sekarang dan wujudkan impian Anda menjadi bidan terampil, siap kerja, dan berdaya saing.
            </p>
            <a
              href="/kontak"
