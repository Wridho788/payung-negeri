...
export default function D3KebidananPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 px-6 md:px-8 bg-linear-to-br from-[#FCAF35]/30 via-orange-100 to-white text-primary-900 overflow-hidden">
      ...
      {/* CTA Final Section */}
      <section className="py-16 md:py-24 px-6 md:px-8 bg-linear-to-br from-[#FCAF35] via-orange-400 to-primary-400 text-primary-900">
