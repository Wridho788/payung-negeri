...
export default function BidanProfsiBidanPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 px-6 md:px-8 bg-linear-to-brrom-primary-50 via-[#FCAF35]/30 to-white text-primary-900 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {curriculumData.map((item, idx) => (
              <div
                key={idx}
                className="relative bg-linear-to-br from-primary-50 to-[#FCAF35]/30 rounded-2xl shadow-md border border-primary-100 p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow group"
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-xl bg-linear-to-br from-primary-600 to-[#FCAF35] text-white flex items-center justify-center text-2xl shadow-lg border-4 border-white group-hover:scale-110 transition-transform">
                  🎓
                </div>
                <div className="mt-8">
      ...
      {/* CTA Final Section */}
      <section className="py-16 md:py-24 px-6 md:px-8 bg-linear-to-r from-primary-600 via-[#FCAF35] to-primary-400 text-white">
