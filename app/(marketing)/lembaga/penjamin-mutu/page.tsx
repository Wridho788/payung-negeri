...
export default function PenjaminanMutuPage() {
  return (
    <>
      {/* Hero */}
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gradient-to-br from-[#291309] via-primary-50 to-white text-primary-900">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#291309]">Penjaminan Mutu</h1>
          <p className="text-xl md:text-2xl text-[#291309]/80 mb-8 max-w-2xl mx-auto">
            Menjamin Kualitas Pendidikan melalui Sistem yang Terstruktur dan Berkelanjutan
          </p>
          <a href="#sistem" className="inline-block px-8 py-3 bg-[#009ADB] text-white rounded-lg font-semibold hover:bg-[#291309] hover:text-white transition-colors shadow-lg">
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-white" id="tentang">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#291309] mb-6">Tentang LPM / SPMI</h2>
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gray-50" id="sistem">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#291309] mb-12 text-center">Sistem Penjaminan Mutu (PPEPP)</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            {ppeppSteps.map((step, idx) => (
              <div key={idx} className="flex-1 bg-white rounded-2xl shadow-md p-8 border border-blue-100 flex flex-col items-center text-center min-w-[180px]">
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#291309] mb-12 text-center">Standar Mutu</h2>
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#291309] mb-12 text-center">Dokumen Mutu</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {qualityDocs.map((doc, idx) => (
              <div key={idx} className="bg-white p-8 rounded-2xl shadow-md flex flex-col items-center text-center border border-blue-100">
                ...
                <a href={doc.file} className="inline-block px-6 py-2 bg-[#009ADB] text-white rounded-lg font-semibold hover:bg-[#291309] transition-colors shadow">
                  Download
                </a>
              </div>
            ))}
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#291309] mb-12 text-center">Siklus Evaluasi</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            {evaluationCycle.map((item, idx) => (
              <div key={idx} className="flex-1 bg-[#009ADB]/10 rounded-2xl shadow-md p-8 border border-blue-100 flex flex-col items-center text-center min-w-[180px]">
                <div className="text-4xl mb-4">{item.icon}</div>
                <h3 className="text-lg font-bold text-[#009ADB] mb-2">{item.title}</h3>
              </div>
            ))}
      ...
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-[#291309] mb-12 text-center">Struktur Organisasi</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {orgStructure.map((person, idx) => (
              <div key={idx} className="bg-white rounded-2xl shadow-md border border-blue-100 p-8 flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-bold text-[#291309] mb-1">{person.name}</h3>
      ...
      {/* CTA Final */}
      <section className="py-16 md:py-24 px-6 md:px-8 bg-gradient-to-r from-[#291309] via-[#009ADB] to-[#FCAF35] text-white">
