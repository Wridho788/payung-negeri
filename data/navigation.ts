...
export const NAV_ITEMS: NavItem[] = [
    ...
    children: [
      {
        ...
        children: [
          { label: "S1-Ilmu Kesehatan Masyarakat", href: "/fakultas/s1-ilmu-kesehatan-masyarakat" },
          { label: "S1-Bidan dan Profesi Bidan", href: "/fakultas/s1-bidan-dan-profesi-bidan" },
          { label: "S1-Informatika Kesehatan", href: "/fakultas/s1-informatika-kesehatan" },
  ...
  },
  {
    label: "Lembaga",
    children: [
      { label: "Penelitian dan Pengabdian Masyarakat", href: "/lembaga/penelitian-pengabdian" },
